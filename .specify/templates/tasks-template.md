...
**Tests**: Tests are REQUIRED for downtime event logic and parsing changes. For
all other work, include tests only if explicitly requested in the feature
specification.
...
- [ ] T010 Implement ingestion scheduler and raw payload storage
- [ ] T011 [P] Add ingestion observability (logs/metrics/freshness tracking)
